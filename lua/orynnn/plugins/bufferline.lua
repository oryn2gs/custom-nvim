...
return {
  ...
  event = "VeryLazy",
  keys = {
    {"<Tab>", ":BufferLineCycleNext<CR>", desc = "Bufferline Next Buffer" },
    {"<S-Tab>", ":BufferLineCyclePrev<CR>", desc = "Bufferline Previous Buffer" },
    {"<leader>bc", ":BufferLinePick<CR>", desc = "Bufferline Pick Buffer" },
    {"<leader>bx", ":BufferLinePickClose<CR>", desc = "Bufferline Pick to Close" },
    {"<leader>bp", ":BufferLineTogglePin<CR>", desc = "Bufferline Toggle Pin Buffer" },
    { "<leader>bb", "<cmd>BufferLineMovePrev<CR>", { desc = "Bufferline move buffer left" } },

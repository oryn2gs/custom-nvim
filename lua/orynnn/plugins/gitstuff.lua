...
return {
  -- Git
  {
    ...
    keys = {
      ...
      { "<leader>gd", ":Gdiffsplit<CR>", desc = "Git diff current buffer - vim-fugitive" },
    },
  },
  {
    ...
    keys = {
      ...
      { "<leader>gG", "<cmd>Copilot panel<CR>", desc = "Git copilot dashboard" },
    },
    config = function()
      ...
      vim.api.nvim_set_keymap(
        ...
        "<C-J>",
        'copilot#Accept("<CR>")',
        { desc = "Github copilot accept suggestion", silent = true, expr = true }
      )
    end,
  },
